...
class tree: ## tree class
    ...
    def plotPoints(self,ax,x_attr=None,y_attr=None,target=None,size=None,colour=None,
        ...
        for k in filter(target,self.Objects):
            ...
            edge_colors.append(edgecolor(k)) if callable(edgecolor) else edge_colors.append(edgecolor)
        ...
        ax.scatter(xs,ys,s=sizes,facecolor=colours,edgecolor=edge_colors,zorder=zorder,**kwargs) ## put a circle at each tip
        if outline:
